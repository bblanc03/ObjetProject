...
public class DVDController {
	...
	public void initialiserVueDVD() {
		...
		// colNbrDisque.setCellValueFactory(col ->
		// col.getValue().getNbrDisqueProperty().asObject());
		colEtatDVD.setCellValueFactory(col -> col.getValue().getEtatProperty());
		// colPretDVD.setCellValueFactory(col ->
		// col.getValue().getPretProperty().asObject());
		// colEmprunteurDVD.setCellValueFactory(col ->
		// col.getValue().getDatePublicationProperty());
	}
